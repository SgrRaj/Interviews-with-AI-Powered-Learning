...
const InterviewPrep = () => {
  ...
  const fetchQuestions = useCallback(async () => {
    ...
    try {
      ...
      const fetchedQuestions = res.data.session.questions || [];
      setQuestions(fetchedQuestions);

      if (!hasAutoGenerated.current && fetchedQuestions.length === 0) {
  ...
  const generateQuestions = async (isAuto = false) => {
    setGenerating(true);
    try {
      await axios.post(API_PATHS.AI.GENERATE_QUESTIONS, { sessionId: id });
      await fetchQuestions();
      if (!isAuto) toast.success("Questions generated!");
    } catch (err) {
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <GenerateButton
            ...
            generating={generating || autoGenerating}
            loading={loading}
          />
        </div>
